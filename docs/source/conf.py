...
from mingaleg_lib import VERSION, VERSION_SHORT
...
html_title = f"mingaleg-lib v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/mingaleg/mingaleg_lib",
            "html": """
...
class ShutupSphinxAutodocTypehintsFilter(logging.Filter):
    def filter(self, record: logging.LogRecord) -> bool:
        return "Cannot resolve forward reference" not in record.msg
